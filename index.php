...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Dentists in Naples</title>
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            <li>
            	<span>Image 01</span>
            		<div>
            			<h3>Dentists in Naples</h3>
            		</div>
            </li>
            <li><span>Image 02</span><div><h3>for the smile</h3></div></li>
            <li><span>Image 03</span><div><h3>of your life</h3></div></li>
            <li><span>Image 04</span><div><h3>for the smile</h3></div></li>
            <li><span>Image 05</span><div><h3>of your life</h3></div></li>
            <li><span>Image 06</span><div><h3>Dentists in Naples</h3></div></li>
        </ul>
        <div class="container">
            <!-- Codrops top bar -->
           <!--  <div class="codrops-top">
            ...
            <header>
                <h1> <span>Dentists in Naples for smiles</span></h1>
